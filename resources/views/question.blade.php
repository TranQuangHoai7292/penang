    ...
    <script type="text/javascript">
            ...
            function timer() {
                ...
                if (now >= timeup) {
                    var change = 'Hãy trả lời đúng câu hỏi kiểm tra văn hóa dành cho bạn. Cố gắng suy nghĩ kỹ và trả lời đúng nhé. Chúc bạn may mắn và đây là 5 câu hỏi của bạn:<br><br>\n' +
                        '        ';
